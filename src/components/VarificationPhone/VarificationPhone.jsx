    ...
    return (
        <div className='md:w-[700px] h-full md:h-[680px] max-w-xl w-full bg-[#1B434D] rounded-xl py-2 px-3 mx-auto  my-12 lg:my-36'>
            ...
            <div className='text-white text-center space-y-1 relative bottom-8'>
                <h2 className='text-[40px] font-bold'>Verifation Phone</h2>
            ...
            <div className=' relative bottom-6'>
                <div className='flex justify-center gap-1'>
                    {
                        data.map(items =>
                            <input className='border w-12 h-12 md:w-[64px] md:h-[72px] my-2 border-gray-400 rounded-xl bg-[#1B434D]' value={items.id} />)
                    }

                </div>
                <p className=' text-lg text-white md:text-right md:mr-28'>Sent Again</p>
            </div>
            <Link to="/searchbusiness">
...
export default VarificationPhone;